...
class Maintenance {
    ...
    private int harga = 0;
    private ArrayList<LocalDateTime> tanggalList = new ArrayList<>();
    ...
    public void addTanggal(int year, int month, int date, int hrs, int min, int sec) {
        LocalDateTime d1 = LocalDateTime.of(year, month, date, hrs, min, sec);
        tanggalList.add(d1);
    }
    ...
    public ArrayList<LocalDateTime> getTanggalList() {
        return this.tanggalList;
    }
}
                    ...
                    do {
                        ...
                        switch (innermenu) {
                            ...
                            case 3:
                                ...
                                System.out.println("Proses delete selesai");
                                break;
                            case 4:
                ...
                case 2:
                    ...
                    if (count2 == 0) {
                        ...
                        for (Maintenance maintenance : assetMaintenance) {
                            System.out.printf("| %-3s | %-20s | %-20s | %-20s | %-20s  |\n", i, maintenance.getNama(), maintenance.getCatatan(), maintenance.getHarga(),maintenance.getTanggalList());
                            i++;
                        }
                        System.out.println("=====================================================================================================");
                    }
                    ...
                    maintenance.addTanggal(year, month, date, hrs, min, sec);
